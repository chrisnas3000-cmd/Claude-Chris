      ...
      <ul className="flex gap-6">
        {menuItems.map(({ title, icon, gradientFrom, gradientTo }, idx) => (
          <li
            ...
            style={
              {
                // Cast added during integration. TypeScript's CSSProperties does
                // not allow custom properties, so the original source fails to
                // compile in a TS project. This is the minimum change needed.
